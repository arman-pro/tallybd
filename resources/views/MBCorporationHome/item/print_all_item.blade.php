...
<html dir="ltr" lang="en">
  <head>
    ...
    <link
      ...
      type="image/png"
      sizes="16x16"
      href="{{asset('MBCorSourceFile')}}/assets/images/favicon.png"
    />
    <!-- Custom CSS -->
          ...
          <table class="table table-resposive table-bordered" >
                      <tr>
                         <td colspan="9" style="text-align: center;">
                             <h3 style="font-weight: 800;">MB CORPORATION</h3>
                             <p>Purbo Dhaka Road, Santahar, Adamdifhi, Bogra, Tel: 0741-69686, Num: 01711185953</p>
                             <h5>List of All Item</h5>
                         </td>   
                        </tr>
                        ...
                        <tr> 
                          ...
                          <td>{{$row->how_many_unit}}  {{$row->unit_name}}</td>
                          <td>{{$row->purchases_price}}.00tk</td>
                          <td>{{$row->sales_price}}.00tk</td>
                          <td>{{$row->previous_stock}}</td>
                          <td>{{$row->total_previous_stock_value}}.00tk</td>
