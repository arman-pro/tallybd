...
<div class="card">
    <div class="card-body">
        <h4 class="card-title" style=" font-weight: 800; ">Designations Information</h4>
    </div>
</div>
            ...
            <div class="col-md-4">
              <div class="card">
                    <div class="card-body">
                        ...
                        @csrf
                                <h4 class="card-title" style=" font-weight: 800; padding-bottom: 10px; border-bottom: 2px solid #eee; background-color: #DC7633; padding: 5px; color: #fff;">Add Designations</h4><br>

                                <input class="form-control" type="text" name="name" placeholder=" Name">
                                <br>
                                <br>
                                <button class="btn btn-success" style="color: #fff;">Add Designations</button>
                            </form>
