...
<div style="background: #fff;margin-bottom: 500px;">
    ...
    <div class="row">
        <div class="col-md-12" style="margin: 2%;" id="main_table">
            ...
            <table class="table table-bordered"
                ...
                <td colspan="7" style="text-align: center;">
                        ...
                        <p style="text-align: left;">Account : {{ $employee->name }} </p>
                        <p style="text-align: left;">Address: {{ $employee->present_address }} </p>
                        <p style="text-align: left;">Mobile No: {{ $employee->mobile }} </p>
                        <p style="text-align: right; padding: 0px;">From : {{request()->from_date." to ".request()->to_date}}</p>
        ...
        <a href="#" onclick="printData()" class="btn btn-light border text-black-50 shadow-none"><i class="fa fa-print"></i> Print</a>
    </div>
</div>
