...
<div class="card">
    <div class="card-body">
        <h4 class="card-title" style=" font-weight: 800; ">Edit Salary Generate</h4>
    </div>
</div>
                    ...
                    <div style="text-align: left;">
                        ...
                        @endif
                            ...
                            <form   action="{{url('salary/update', $salary->id)}}" method="POST">
                                ...
                                {{-- <input type="hidden"  name="department_id" value="{{ $salary->department_id??null }}">
                                <input type="hidden"  name="designation_id" value="{{ $salary->department_id??null }}">
                                <input type="hidden"  name="shift_id" value="{{ $salary->department_id??null }}"> --}}
