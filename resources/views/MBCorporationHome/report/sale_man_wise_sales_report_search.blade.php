...
<div style="background: #fff;">
    <h3 style="height:50px;text-align: center; padding-top: 10px;border-bottom: 3px solid #eee;">Sele Man Wise Sales</h3>
   <div class="row">
        <style type="text/css">
            .topnav {
            overflow: hidden;
            ...
            @csrf<div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="cono1" class="control-label col-form-label">Sales Man Name :</label>
                        <div>
                            <select class="form-control" name="sale_man_id" required>
