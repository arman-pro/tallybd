...
@section('title', "All salesretrun Report")
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-success text-light">
                    <h4 class="card-title">All Sale Retrun By Date Report</h4>
                </div>
                <div class="card-body">
                        ...
                        <thead>
                            ...
                            <tr>
                                <th class='text-center' colspan="7" style=" border:0px !important;">
                                    ...
                                    <h4 style="margin:0">All Sales Retrun Report</h4>
                            ...
                            <tr style="font-size:14px;font-weight: 800;">
                                    ...
                                    <th style="width:19%">Item Details</th>
                         ...
                         @php
                                $purchases = App\SalesReturnAddList::whereBetween('date',[$formDate,$toDate])->orderBy('date')->get();
                                @endphp
                        <tbody>
                             <?php
                                $total_price__ = 0;
