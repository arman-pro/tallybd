                    ...
                    <table class="table table-bordered" cellspacing="0" style="width: 100%;">
                        ...
                        <tbody>
                            ...
                            @endphp    
                                <tr>
                                    ...
                                    <td style="text-align:right"><b>
                                        @if ( $ledgertotal  > 1)
                                        {{ number_format($ledgertotal??0, 2) }}(DR)
                                        @else
                                        {{ number_format($ledgertotal *-1 ??0, 2) }}(CR)
                                        @endif
                                    </b></td>
                                </tr>
                            ...
                            <tr>
                                ...
                                <td style="text-align:right;">{{ number_format($stockValue??0, 2) }}</td>
                            </tr>
                            <tr>
                                <td style=" text-align:left;padding:1px"><strong>Profit/Loss</strong> </td>
                                @if($getProfit['profit']  > 0)
                                <td style="text-align:right;">{{ number_format($getProfit['profit']??0, 2) }} (DR)</td>
                                @else
                                <td style="text-align:right;">- {{ number_format($getProfit['loss']??0, 2) }} (CR)</td>
                            ...
                            <tr style="background: rgb(91, 165, 91);font-size:16pssx">
                                ...
                                <td style="border-top: 1px solid #97959582; text-align:right">
                                    ...
                                    {{ number_format($asset_grand_total + $getProfit['profit'] + $stockValue - $getProfit['loss'], 2) }} (Dr)
                                    @else
                                    {{ number_format(($asset_grand_total + $getProfit['profit'] + $stockValue - $getProfit['loss'])*-1, 2) }} (Cr)
                                    @endif
                                </td>
                            </tr>
                            @endif
                        ...
                        <tbody>
                            ...
                            <tr style="background-color: rgb(207, 107, 107); font-size:16px">
                                ...
                                <td style="border-top: 1px solid #97959582;text-align:right">
                                    ...
                                    {{ number_format($liability_grand_total, 2) }} (Dr)
                                    @else
                                    {{ number_format(($liability_grand_total)*-1, 2) }} (Cr)
                                    @endif
