...
@section("title", "All Purchase Retrun Report")
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header bg-dark text-light">
                    <h4 class="card-title">All Purchase Retrun</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12" id="">
                            <table id="printArea" class="display" style="width:100%">
                                ...
                                @php
                                $purchases = App\PurchasesReturnAddList::whereBetween('date',[$formDate,$toDate])->orderBy('date')->get();
                                @endphp
                                <tbody>
                                    <?php
                                        $total_price__ = 0;
