...
@section('title', "Godown Wise Stock Summery Report")
    ...
    <div class="row">
            ...
            <form action="{{url('/stock_summery_report_godown_search_from')}}" method="GET">
                <div class="card">
                    <div class="card-header bg-primary text-light">
                        <h4 class="card-title">Godown Wise Stock Summery Report</h4>
                    </div>
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-md-4 col-sm-12">
                                ...
                                <select class="form-control" name="godown_id" required>
                                    <option value="" hidden>Select a Godwon</option>
                                    @php
		...
		<div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-footer text-center">
                    <button class="btn btn-lg btn-primary text-light fw-bold"  onclick="printData()"><i class="fa fa-print"></i> Print</button>
