...
<div style="background: #fff;margin-bottom: 500px;">
    <h3 style="height:50px;text-align: center; padding-top: 10px;border-bottom: 3px solid #444242;">Account Ledger</h3>
    <div class="row">
        ...
        <div class="col-11" style="margin: 1%; overflow-x:auto;" id="main_table">
