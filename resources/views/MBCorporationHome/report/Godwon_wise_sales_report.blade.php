...
@section('title', "Godwon Wise Sale Report")
            ...
            <div class="card">
                ...
                <table id="printArea" class="display" style="width:100%">
                    <thead>
                        <tr>
                            <th colspan="7" style="text-align: center; border:0px !important;">
                                ...
                                $godowns = App\Godown::where("id", $godown_id)->first();
                                @endphp
                                ...
                                @endforeach
                                <h4 style="margin:0;">Godwon Wise Sales</h4>
                                <h4 style="margin:0;">Godwon Name: {{$godowns->name??0}}</h4>
                    ...
                    @php
                        ...
                        $purchases = App\SalesAddList::where('godown_id',$godown_id)
