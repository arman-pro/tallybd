    ...
    <table class="head_table">
        <tbody>
            ...
            <tr>
                ...
                <td style="width: 65%;">{{$account_ledger->account_name}}</td>
    ...
    <table class="print-table">
        ...
        <tbody>
            <tr>
                ...
                <td class="text-left padding-left-5" style="font-size:15px;font-weight:bold;">{{$payment->employee->name }}- - {{$payment->employee->designation->name ?? "N/A"}}</td>
                <td style="font-size:15px;font-weight:bold;">{{new_number_format($payment->amount)}}</td>
            </tr>
        ...
        <tfoot>
            <tr>
                ...
                <td style="font-size:15px;font-weight:bold;">{{new_number_format($payment->amount ?? 0)}}</td>
            </tr>            
        </tfoot>
    </table>
