                            ...
                            style=" font-weight: 800;text-align:center; padding-bottom: 10px; border-bottom: 2px solid #eee; background-color: #DC7633; padding: 5px; color: #fff;">
                             ...
                             <form action="{{route('salary_payment.store')}}" method="Post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5 pay_cls">
                                        <div class="form-groups">
                                            <label for="payment_by" style="text-align:left;display:block">Payment By *</label>

                                            <select  name="payment_by"  class="select2" style="width: 200px" required="" >
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-groups">
                                            ...
                                            <input type="text" class="form-control" style="text-align: center;font-size:17px;font-weight:bold;" id="name" name="amount"
