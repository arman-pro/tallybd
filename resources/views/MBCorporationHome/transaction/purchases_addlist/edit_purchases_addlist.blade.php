                                ...
                                <table class="table table-bordered" id="myTable">
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td>
                                                <div id="sales_price" class="fw-bold"></div>
                                            </td>
                                            <td>
                                                <input 
                                                    type="text" name="discount_on_product" 
                                                    id="discount_on_product"
                                                    oninput="qty_product()" class="form-control fw-bold"
...
<script>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $.each(response, function(key, value) {
                    ...
                    item = '<input type="show" name="price_as_product" id="price_as_product" oninput="qty_product()" class="form-control" value="' + item_price + '">';
                })
    ...
    function addondemoproduct() {
        ...
        htmlData += "<td> <input class='item-qty form-control fw-bold' min='0' type='number' name='new_qty[]' value='"+qty_product_value+"' /></td>"
        htmlData += "<td><input readonly class='form-control fw-bold' type ='number' name='new_price[]' step='any' value='"+price_as_product+"' /> </td>"
        htmlData += "<td> <input readonly class='form-control fw-bold' type ='number' name='new_discount[]' step='any' value='"+discount_on_product+"' /></td>"
        htmlData += "<td><input  class='item-charge form-control fw-bold' readonly  type ='number' step='any' name='new_subtotal[]' value='"+subtotal_on_product.toFixed(2)+"' /> </td>"
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $.each(response, function(key, value){
                    ...
                    data += "<td><input class='item-qty form-control fw-bold' readonly  type ='number' name='qty[]' value='"+value.qty+"' /></td>"
                    data += "<td><input class='form-control fw-bold'  readonly  type ='number' name='price[]' step='any' value='"+value.price+"' /> </td>"
                    data += "<td> <input class='form-control fw-bold' readonly  type ='number' name='discount[]' step='any' value='"+value.discount+"' /></td>"
                    data += "<td><input  class='item-charge form-control fw-bold' readonly  type ='number' step='any' name='subtotal[]' value='"+value.subtotal_on_product+"' /> </td>"
