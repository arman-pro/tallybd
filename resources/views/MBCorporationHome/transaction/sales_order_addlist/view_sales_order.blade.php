...
@php
	$sale = App\SalesOrderAddList::where('id',$product_id_list)->first();
...
<div style="background: #fff; text-align: center;color: #fff;">
		<a href="{{URL::to('/print_sales_order_invoice/'.$sale->product_id_list)}}" class="btn btn-info" style="color: #fff;">Print</a>
</div>
@endsection
