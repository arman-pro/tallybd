        ...
        <table style="width: 100%">
            <tr>
                <td colspan="6" style="padding: 5px;">Invoice NO. : <span
                        style="font-weight: 700;">{{$product_id_list}}</span></td>
                <td colspan="2" style="padding: 5px 20px;text-align: right;">Date : <span
                        style="font-weight: 700;">{{$purchases->date}}</span></td>
            </tr>
            <tr>
                <td colspan="7" style="text-align: center;padding-top: 10px;">
                    ...
                    @endforeach
                    <span style="font-size: 18px;font-weight: 800;border-bottom: 4px solid #566573;">SALES ORDER</span>
                </td>
                @php
                $row = App\Companydetail::where('id','1')->first();
                @endphp
            ...
            <tr style="border-top: 1px solid #eee;text-align: center;">
                ...
                <td style="width: 10%;border-right: 1px solid #eee;">{{ number_format($row->qty, 2)}}</td>
                <td style="width: 5%;border-right: 1px solid #eee;">{{$item->unit->name}}</td>
                <td style="width: 15%;border-right: 1px solid #eee;">{{number_format ($row->price,2)}}.TK
                </td>
                <td style="width: 5%;border-right: 1px solid #eee;">{{$item->unit->name}}</td>
                <td style="width: 5%;border-right: 1px solid #eee;"></td>
                <td style="width: 20%;">{{ number_format($row->price * $row->qty, 2)}}.TK</td>
            </tr>
            @endforeach
            <tr style="border-top: 1px solid #eee;text-align: center;">
            ...
            <tr style="border-top: 1px solid #eee;text-align: center;font-size: 16px;font-weight: 800;">
                ...
                <td style="width: 5%;border-right: 1px solid #eee;"></td>
                <td style="width: 5%;border-right: 1px solid #eee;"></td>
                <td style="width: 20%;">{{ number_format($total_amount, 2)}}.TK</td>
            </tr>
                    ...
                    <tr style="border-top: 1px solid #eee;text-align: center;">
                        ...
                        <td colspan="3">
                    		...
                    		<img src="{{asset('MBCorSourceFile')}}/assets/images/md_signature.jpeg">'
                    		@endif
