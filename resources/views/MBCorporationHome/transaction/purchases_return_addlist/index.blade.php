            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title"
                        ...
                        Purchases Return</h4>
                    <a href="{{route('purchases_return_addlist_form')}}" class="btn btn-success"
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-content">
                                            <a href="{{URL::to('/edit_purchases_return/'.$purchasesAddList_row->id)}}" class="btn btn-sm btn-success" style="color: #fff;"><i class="far fa-eye"></i></a>
                                            <a href="{{URL::to('/edit_purchases_return/'.$purchasesAddList_row->id)}}" class="btn btn-sm btn-primary"><i class="far fa-edit"></i></a>
                                            <a href="{{URL::to('/send_purchases_return_sms/'.$purchasesAddList_row->id)}}" onclick="alert('Do You want to send sms?')" class="btn btn-sm btn-warning"><i class="fa fa-envelope"></i></a>
                        			        <a href="#" data-id="{{$purchasesAddList_row->product_id_list}}" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
                                            <a target="_blank" href="{{URL::to('/print_pruchases_return_invoice/'.$purchasesAddList_row->product_id_list)}}" class="btn btn-sm btn-info" style="color: #fff;"><i class="fas fa-print"></i></a>
                                        </div>
                                    </div>
...
<script>
    ...
    var here = $(this);
    var url = "{{url('/delete_purchases_return')}}"+ '/' +$(this).data('id');
