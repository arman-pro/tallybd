        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header bg-success">
                    <h4 class="card-title">Add Purchase Return</h4>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                            ...
                            <div class="form-group row">
                                <label for="cono1" class="control-label col-form-label heighlightText">Account Ledger</label>
                                    <select 
                                        ...
                                        id="account_ledger_id" class="select2 form-control" style="width: 100%" required
                ...
                <div class="card-footer fw-bold text-center">
                    ...
                    <button class="btn btn-outline-info" name="print" value="1"><b>Save & Print</b></button>
