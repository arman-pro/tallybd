                                    ...
                                    <table class="table table-bordered" id="myTable">
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" min="0" placeholder="Amount" name=""
...
@push('js')
    <script>
        ...
        function addDemoContraJournal() {
            ...
            htmlData += "<td><input type='hidden' name='new_account_id[]' value='" + account_id + "'/>" + account_name +
                "</td>"
            ...
            htmlData += "<td> <input class='form-control' placeholder='Note' type ='text' name='new_note[]' value='" +
                note + "' /></td>"
            htmlData +=
                "<td><button type='button' class='btn btn-sm btn-danger' onclick='delete_data(this)'><i class='fa fa-trash'></i></button></td>"
            htmlData += "</tr>";
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(response, function(key, value) {
                        ...
                        htmlData += "<tr class='item'>"
                        // htmlData +=
                        //     "<td  style='display:none'><input type='hidden' name='id[]' value='" + value
                        //     .id + "'/> </td>"
                        htmlData +=
                            "<td  style='display:none'><input type='hidden' name='new_account_id[]' value='" +
                            value.ledger_id + "'/> </td>"
                        ...
                        htmlData +=
                            ...
                            value.drcr + "' /></td>"
                        htmlData +=
                            "<td><input class='form-control'  type ='number' name='new_amount[]' value='" +
                            value.amount + "' /> </td>"
                        htmlData +=
                            "<td> <input class='form-control' placeholder='Note'  type ='text' name='new_note[]' value='" +
                            value.note + "' /></td>"
                        htmlData +=
                            "<td><a class='btn btn-sm btn-danger' onclick='delete_data(this)'><i class='fa fa-trash'></i></a></td>"
                        htmlData += "</tr>";
                    });
