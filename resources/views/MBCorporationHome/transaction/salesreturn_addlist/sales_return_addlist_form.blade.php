                ...
                <form action="{{ url('/SaveAllData/sales_return/store') }}" method="post">
                    ...
                    <div class="card-body" style="border: 1px solid #69C6E0;border-radius: 5px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <table class="table table-bordered">
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group row">
                                                <label for="cono1" class="control-label col-form-label">SaleMen :</label>
                                                <div>
                                                    <select class="form-control" style="text-align: center;" name="SaleMen_name"
                            ...
                            <div class="col-md-4">
                                <div class="form-group row">
                                    ...
                                    {{-- <div>
                                        <select class="form-control" name="account_ledger_id" id="account_ledger_id"
                                            onclick="account_details()" required>
                                            <option value=" ">Select</option>
                                            @foreach($account as $account_row)
                                            <option value="{{$account_row->id}}">
                                                {{$account_row->account_name}}</option>
                                            @endforeach
                                        </select>
                                    </div> --}}
                        ...
                        <div style="text-align: center; color: #fff; font-weight: 800;">
                            ...
                            <button onclick="" class="btn btn-info" name="print" value="1"
                                style="color:#fff; font-weight: 800;font-size: 18px;">Save & Pirnt</button>
