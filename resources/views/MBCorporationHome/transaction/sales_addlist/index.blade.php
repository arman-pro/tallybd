        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body" style="overflow-x:auto;">
                    ...
                    <a href="{{route('sales_addlist_form')}}" class="btn btn-success"
                        style="color:#fff; float: right;">+Add New</a><br>
                        ...
                        <tbody>
                            ...
                            <tr style="text-align: center;">
                                ...
                                <td>
                                    ...
                                    {{ new_number_format($row->price)??"0"}}<br>
                                    @endforeach
                                </td>
                                <td>
                                    @foreach($item_detais as $row)
                                ...
                                <td>
                                   ...
                                   <div class="dropdown">
                                        ...
                                        <div class="dropdown-content">
                                            <a href="{{URL::to('/view_sales/'.$purchasesAddList_row->id)}}"
                                                class="btn btn-sm btn-success" style="color: #fff;"><i
                                                    class="far fa-eye"></i> Veiw</a>
                                            <a href="{{URL::to('/edit_sales/'.$purchasesAddList_row->id)}}"
                                                class="btn btn-sm btn-primary"><i class="far fa-edit"></i> Edit</a>
                                            <a href="{{URL::to('/send_sales_sms/'.$purchasesAddList_row->id)}}"
                                                onclick="alert('Do You want to send sms?')" class="btn btn-sm btn-warning"><i
                                                    class="far fa-envelope"></i> SMS</a>
                                            {{-- <a href="{{URL::to('/delete_sales/'.$purchasesAddList_row->product_id_list)}}"
                                                onclick="alert('Do You want to delete?')" class="btn btn-sm btn-danger"><i
                                                    class="fa fa-trash"></i></a> --}}
                        			        <a href="#" data-id="{{$purchasesAddList_row->product_id_list}}" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i> Delete</a>

                                            <a target="_blank"
                                                href="{{URL::to('/print_sales_invoice/'.$purchasesAddList_row->product_id_list)}}"
                                                class="btn btn-sm btn-info" style="color: #fff;"><i
                                                    class="fas fa-print"></i> Print</a>
                                                    <a target="_blank"
                                                href="{{URL::to('/print_sales_invoice2/'.$purchasesAddList_row->product_id_list)}}"
                                                class="btn btn-sm btn-info" style="color: #fff;"><i
                                                    class="fas fa-print"></i>Ch:Print</a>
                                        </div>
                                    </div> 
                                </td>
                            </tr>
