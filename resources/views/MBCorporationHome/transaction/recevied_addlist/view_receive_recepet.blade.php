	 ...
	 <table class="table" style="border: 1px solid #eee;" >
           <tr>
              <td colspan="7" style="text-align: center;">
                ...
                @endforeach
                <h4 style="font-size: 16px;">RECEIVE VOUCHER</h4>
              </td>
              @php
            ...
            @php
            	$payment = App\Receive::where('vo_no', $vo_no)->first(); 
            ...
            <tr style="border-bottom: 1px solid #eee;">
              <td colspan="6">
                <p>Voucher No.  &nbsp;  &nbsp;  &nbsp;  &nbsp;:  &nbsp;  &nbsp;{{$payment->vo_no}}</p>
               	<p>Receive Mode  &nbsp;&nbsp;:  &nbsp;  &nbsp;
                    {{-- @dd($receive); --}}
                  {{ optional($receive->paymentMode)->account_name??' ' }}
                </p>
              </td>
            ...
            <tr style="font-size:14px;font-weight: 800;border-bottom: 1px solid #fff;">
              ...
              <td style="padding: 5px 5px;width: 350px;" colspan="3">
                ...
                {{ optional($receive->accountMode)->account_name??' ' }}
              </td>
...
<div style="background: #fff; text-align: center;color: #fff;">
	<a href="{{URL::to('/print_receive_recepet/'.$vo_no)}}" class="btn btn-info" style="color: #fff;">Print</a>
</div>
@endsection
