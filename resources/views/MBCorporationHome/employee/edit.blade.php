...
<div class="card">
    <div class="card-body">
        <h4 class="card-title" style=" font-weight: 800; ">Employees Update Information</h4>
    </div>
</div>
                    ...
                    <div style="text-align: left;">
                        ...
                        <input type="hidden" name="date" value="{{App\Companydetail::with('financial_year')->first()->financial_year->financial_year_from }}">
                            ...
                            <div class="row">
                                ...
                                <button type="submit" class="btn btn-success" style="color: #fff;">Update Employee</button>
                            </div>
                        </form>
