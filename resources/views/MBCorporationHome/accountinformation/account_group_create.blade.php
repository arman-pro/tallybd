              ...
              <div class="card">
              		<div class="card-body" style="border: 1px solid #69C6E0;border-radius: 5px;">
              			...
              			<form action="{{url('/store_account_group')}}" method="POST">
							@csrf
              				<h4 class="card-title" style=" font-weight: 600; padding-bottom: 10px;background-color: #69C6E0; padding: 5px 20px;color: #fff;border-radius: 5px;">Add Account Group </h4><br>
                    		<br>
                   			<div class="row">
			                	...
			                	@endif
		                   		...
		                   		<div class="col-md-6">
		                   			<div class="form-group row">
					                    ...
					                    <div>
					                        <input type="text" name="account_group_name" class="form-control" id="cono1" placeholder="Account Group Name" />
