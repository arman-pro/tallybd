...
<div class="container-fluid">
    ...
    <div class="p-0 content_area" >
        <div>
            ...
            <h4 style="margin:0;text-align:center;">Item Wise Sales</h4>
            ...
            <table class="pdf-table">
                <thead>
                    <tr style="font-size:14px;font-weight: 800;">
                        <th>Date</th>
                        <th>Vch.No</th>
                        <th style="text-align: center;">Account Lager</th>
                ...
                <tfoot>
                    <tr>
                        ...
                        <td colspan="1" style="text-align: right;font-weight:bold">{{ number_format($total_amount, 2) }} Tk. </td>
                    </tr>
                </tfoot>
            </table>
        </div>
