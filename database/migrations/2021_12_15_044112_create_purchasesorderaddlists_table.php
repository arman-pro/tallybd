...
class CreatePurchasesOrderAddListsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('PurchasesOrderAddLists', function (Blueprint $table) {
            $table->id();
            $table->string('date');
    ...
    {
        Schema::dropIfExists('PurchasesOrderAddLists');
    }
}
