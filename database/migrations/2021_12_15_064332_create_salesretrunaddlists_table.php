...
class CreateSalesReturnAddListsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('SalesReturnAddLists', function (Blueprint $table) {
            $table->id();
            $table->string('date');
    ...
    {
        Schema::dropIfExists('SalesReturnAddLists');
    }
}
