...
class CreatePurchasesReturnAddListsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('PurchasesReturnAddLists', function (Blueprint $table) {
            $table->id();
            $table->string('date');
    ...
    {
        Schema::dropIfExists('PurchasesReturnAddLists');
    }
}
